...
r = redis.Redis(decode_responses=True, host="redis-18105.c99.us-east-1-4.ec2.redns.redis-cloud.com", port=18105
                , password="Redis12345")
r.flushdb()
...
if __name__ == '__main__':
    ...
    update_thread.start()
    socketio.run(app=app, host='0.0.0.0', port=8000, use_reloader=False, log_output=False)
